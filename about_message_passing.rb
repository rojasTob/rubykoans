...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Provide a __send__ method because the name "send" is very common and could be used in any class.
    # "__send__" method is a synonymus of "send", if you override "send" you could change the behaviour and 
    # not realize about it and if "__send__" method was overrided Ruby emit a warning about it.
  end
