...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # The ArgumentError was thrown because no arguments was sent to the constructor
  end
  ...
  # .to_s vs .inspect::::::
  # both transform anything to string object but,
  # 'inspect' use a human-readable way text 
