...
# Examples:
#
# score([1,1,1,5,1]) => 1150 points = 1000 + 50 + 100
# score([2,3,4,6,2]) => 0 points = 0 + 0 + 0 + 0 
# score([3,4,5,3,3]) => 350 points =  100 + 50
# score([1,5,1,2,4]) => 250 points =  100 + 50 + 100
#
...
class AboutScoringProject < Neo::Koan
  ...
  def test_score_of_mixed_is_sum
    ...
    assert_equal 1100, score([1,1,1,1]) #<= THIS !
